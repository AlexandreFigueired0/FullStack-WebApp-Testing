...
public class WebAppNarrativeHtmlUnitTest {
	...
	public void createCustomerThenSaleThenDeliveryAndShowDeliveryTest() throws IOException {
		...
		//////////////////////// REVERT ////////////////////////////////
		reportPage = removeDelivery(DELIVERY_ID);
		reportPage = removeSale(VAT,SALE_ID);
		reportPage = removeAddress(VAT,ADDRESS,DOOR,POSTAL_CODE,LOCALITY);
		reportPage = removeCustomer(VAT);
	}


	private HtmlPage removeDelivery(String deliveryID) {
